package com.manhnpc.content.security;
...
/**
 * Simple stateless guard: mutating requests (POST/PUT/DELETE/PATCH) require a
 * valid HS256 JWT signed with the shared secret. Reads pass through freely.
 */
@Component
